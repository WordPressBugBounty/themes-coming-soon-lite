...
function coming_soon_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('coming_soon_lite_logo_size',array(
		'sanitize_callback'	=> 'coming_soon_lite_sanitize_float'
	));
	$wp_customize->add_control('coming_soon_lite_logo_size',array(
		'type' => 'range',
		'label' => __('Logo Size','coming-soon-lite'),
	...
	$wp_customize->add_setting( 'coming_soon_lite_boxfull_width', array(
		'default'           => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_choices'
	));
	
	$wp_customize->add_control( 'coming_soon_lite_boxfull_width', array(
		'label'    => __( 'Section Width', 'coming-soon-lite' ),
		'section'  => 'coming_soon_lite_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'container'  => __('Box Width', 'coming-soon-lite'),
			'container-fluid' => __('Full Width', 'coming-soon-lite'),
			'none' => __('None', 'coming-soon-lite')
		),
	));
	...
	$wp_customize->add_setting('coming_soon_lite_top_bar_font_size',array(
		'default' => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_float'
	));
	$wp_customize->add_control('coming_soon_lite_top_bar_font_size',array(
		'type' => 'number',
	...
	$wp_customize->add_setting( 'coming_soon_lite_slider_effect', array(
		'default'           => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_choices'
	));
	$wp_customize->add_control( 'coming_soon_lite_slider_effect', array(
		'label'    => __( 'Onload Transactions Effects', 'coming-soon-lite' ),
		'section'  => 'coming_soon_lite_banner_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInLeft'  => __('bounceInLeft', 'coming-soon-lite'),
			'bounceInRight' => __('bounceInRight', 'coming-soon-lite'),
			'bounceInUp'    => __('bounceInUp', 'coming-soon-lite'),
			'bounceInDown'    => __('bounceInDown', 'coming-soon-lite'),
			'zoomIn'  => __('zoomIn', 'coming-soon-lite'),
			'zoomOut' => __('zoomOut', 'coming-soon-lite'),
			'fadeInDown'    => __('fadeInDown', 'coming-soon-lite'),
			'fadeInUp'    => __('fadeInUp', 'coming-soon-lite'),
			'fadeInLeft'  => __('fadeInLeft', 'coming-soon-lite'),
			'fadeInRight' => __('fadeInRight', 'coming-soon-lite'),
			'flip-up'    => __('flip-up', 'coming-soon-lite'),
			'none'    => __('none', 'coming-soon-lite')
		),
	));
	...
	$wp_customize->add_setting('coming_soon_lite_banner_font_size',array(
		'default' => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_float'
	));
	$wp_customize->add_control('coming_soon_lite_banner_font_size',array(
		'type' => 'number',
		'label' => __('Font Size','coming-soon-lite'),
		'section' => 'coming_soon_lite_banner_section',
	));
	...
	$wp_customize->add_setting('coming_soon_lite_banner_heading_font_size',array(
		'default' => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_float'
	));
	$wp_customize->add_control('coming_soon_lite_banner_heading_font_size',array(
		'type' => 'number',
		'label' => __('Font Size','coming-soon-lite'),
		'section' => 'coming_soon_lite_banner_section',
	));
	...
	$wp_customize->add_setting('coming_soon_lite_banner_date_font_size',array(
		'default' => '',
		'sanitize_callback' => 'coming_soon_lite_sanitize_float'
	));
	$wp_customize->add_control('coming_soon_lite_banner_date_font_size',array(
		'type' => 'number',
		'label' => __('Font Size','coming-soon-lite'),
		'section' => 'coming_soon_lite_banner_section',
	));
	...
	$wp_customize->add_setting( 'coming_soon_lite_bannerdatebdr_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coming_soon_lite_bannerdatebdr_color', array(
		'label' => __('Date Border Color', 'coming-soon-lite'),
		'section' => 'coming_soon_lite_banner_section',
	)));
